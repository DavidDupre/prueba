<template>
  <div class="row q-col-gutter-md q-pb-md q-px-md tw-mt-5">
    <div class="col row q-ml-md">
      <h3 class="tw-text-xl text-bold">Soporte de Salida</h3>
    </div>

    <div class="cols-12 full-width">
      <span class="tw-text-label q-ml-lg">Adjuntar Archivos </span>
      <FileLoader
      class="tw-w-full"
      multiple
  ...
  <Modal v-model="cancelarModal" title="Confirmación" persistent
  text="Al cancelar el proceso perderá los archivos cargados en el formulario, ¿desea realizar la acción?"
  :is-success="false" :cancelButton="true" @closeModal="cancelarModal = false" textButtonCancel="Cancelar" text-button="Aceptar"
