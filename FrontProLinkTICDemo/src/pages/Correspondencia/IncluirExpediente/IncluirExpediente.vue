<template>
  ...
  <CrearExpediente ref="crearComp" v-if="crearExp" :cor-data="props.corData" @is-exp="isCrearExpediente" />
...
const loadExpedientes = async () => {
  try {
    ...
    const response = await sgdeaAxios.get(`/expediente`, {
      params: { idSubserie: formData.value.subSeries, modulo: 8 },
    });
