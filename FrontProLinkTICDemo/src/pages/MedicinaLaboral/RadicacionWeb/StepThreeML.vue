    ...
    <q-card class="tw-rounded-xl q-pa-lg" flat greedy>
      ...
      <div class="tw-mt-2">
        <div class="row q-col-gutter-md q-pb-md q-px-md">
          ...
          <div v-if="props.firstForm.canal.value === 4 && props.firstForm.tipoRemitente === 1" class="col-12 tw-text-label tw-mt-[-20px]">
          ...
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
            <label class="tw-w-full">
              ...
              <q-select v-model="form2.constanciaEjecutoriedad" label="Seleccione" dense outlined class="tw-rounded-lg"
                ...
                :disable="Number(props.firstForm.tipoRemitente) !== 3 || Number(form2.tipoSolicitud) !== 5 || disabledInputs">
              </q-select>
            </label>
          </div>
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <label class="tw-w-full">
              ...
              <Datepicker mask="DD/MM/YYYY" label="dd / mm / aaaa"
                :disable="Number(form2.tipoSolicitud) !== 5 || disabledInputs || !form2.constanciaEjecutoriedad"
...
const validateForms = async () => {
  ...
  const requiresProof =
    props.firstForm.canal.value === 4 && props.firstForm.tipoRemitente === 1;
...
watch(() => form2.value.tipoSolicitud, (val) => {
  if (val !== '5') {
    form2.value.constanciaEjecutoriedad = ''
  }
})
...
const validationDate = (val) => {
  if (!val) return true;
  const inputDate = moment(val, 'DD/MM/YYYY');
