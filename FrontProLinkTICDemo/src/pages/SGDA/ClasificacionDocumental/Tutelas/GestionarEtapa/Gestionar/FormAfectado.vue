<template>
  <q-expansion-item dense expand-separator default-opened class="tw-bg-white q-mt-md" style="border-radius: 5px">
    <template v-slot:header>
      <h3 class="text-bold tw-text-xl tw-flex-1 q-py-md">Datos del Afectado</h3>
    </template>
    <div class='tw-flex tw-flex-col tw-w-full tw-p-4'>
      <span class="tw-font-bold">
        ...
        <q-select emit-value label="Seleccione" outlined :options="opTipoDoc" dense
          v-model="form.tipoDocumento" :rules="[inputRequired]" map-options @update:model-value="clearAfectado" @blur="getPerson" :disable="isPorAprobar"/>
      </span>
    </div>
    <div class="tw-flex tw-flex-col tw-w-full tw-p-4">
      <span class="tw-w-full">
        <label class="tw-font-bold tw-text-gray-dark">Número Documento*</label>
    ...
    <template v-else >
      <div class="tw-flex tw-flex-col tw-w-full tw-p-4">
        <span class="tw-w-full">
          <label class="tw-font-bold tw-text-gray-dark">Primer Nombre*</label>
          <q-input v-model="form.primerNombre" outlined class="tw-rounded-lg" label="Inserte" dense
      ...
      <div class="tw-flex tw-flex-col tw-w-full tw-p-4">
        <span class="tw-w-full">
          <label class="tw-font-bold tw-text-gray-dark">Segundo Nombre</label>
      ...
      <div class="tw-flex tw-flex-col tw-w-full tw-p-4">
        <span class="tw-w-full">
          <label class="tw-font-bold tw-text-gray-dark">Primer Apellido*</label>
          <q-input v-model="form.primerApellido" outlined class="tw-rounded-lg" label="Inserte" dense
            :rules="[v => maxLengthInput(100, v), inputRequired, alphanumeric]" :disable="isPorAprobar"></q-input>
        </span>
      </div>
      <div class="tw-flex tw-flex-col tw-w-full tw-p-4">
        <span class="tw-w-full">
          <label class="tw-font-bold tw-text-gray-dark">Segundo Apellido</label>
