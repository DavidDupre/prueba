...
<!--        </div>-->
      ...
      <q-card class="tw-grid tw-grid-cols-4 tw-gap-4 tw-pb-5 q-mx-md" style="box-shadow: none">
        ...
        <div>
          ...
          <p>{{ formatDateWithTimeAndMeridiem(detalleTutela.fechaRadicacion)}}</p>
        </div>
        ...
        <div>
          ...
          <p>{{ formatDateWithTimeAndMeridiem(detalleTutela.informacionProceso?.fechaRespuesta)}}</p>
        </div>
      </q-card>
    </q-expansion-item>
...
import {formatDateWithTimeAndMeridiem, fourthFormatDate} from "src/helpers/formtDate";
