      ...
      <q-expansion-item default-opened dense expand-separator
          ...
          <q-card class="tw-grid tw-grid-cols-4 tw-gap-4 tw-pb-5 tw-mx-4" style="box-shadow: none">
              <div>
                  ...
                  <p>{{detailsRadicado?.tipoGestion?.nombre || ''}}</p>
              </div>

              <div>
                  <p class="tw-font-bold tw-text-gray-dark">Nombre Comunicacion</p>
                  <p>{{detailsRadicado?.nombre || ''}}</p>
              </div>
              <div>
      ...
      <q-expansion-item default-opened dense expand-separator class="tw-bg-white q-mt-md" style="border-radius: 5px">
          ...
          <q-card class="tw-grid tw-grid-cols-4 tw-gap-4 tw-pb-5 tw-mx-4" style="box-shadow: none">
              <div>
                  ...
                  <p>{{ detailsRadicado?.comunicacionManualDG?.tipoDocumentoAfectadoId?.nombre || '' }}</p>
              </div>
              <div>
                  <p class="tw-font-bold tw-text-gray-dark">Número de documento</p>
                  <p>{{ detailsRadicado?.comunicacionManualDG?.numeroDocumentoAfectado || '' }}</p>
              </div>
              <div>
                  <p class="tw-font-bold tw-text-gray-dark">Nombre</p>
                  <p>{{ detailsRadicado?.comunicacionManualDG?.nombreAfectado || '' }}</p>
              </div>
          </q-card>
      </q-expansion-item>
