<template>
  <div>
    ...
    <h2 class="tw-font-bold tw-text-lg tw-pb-3 tw-pt-2">Motivo de Rechazo</h2>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <span class="tw-text-label">Observación* </span>
      <q-input dense label="Inserte" outlined class="mb-3 " required
               type="textarea" />
    </div>
    <div class="tw-rounded-lg  tw-mt-3">
      <div class="tw-flex tw-gap-2 tw-justify-center tw-items-center tw-pt-10">
        <q-btn
          ...
          outline
          @click="router.push('/SGDA/pqrd/consolidar')"
        />
        <q-btn
          label="Asignar Rechazo"
          color="secondary"
    ...
    <Modal
      ...
      text="¿Está seguro que desea asignar el rechazo?"
      :is-success="false"
      text-button="SI"
      cancel-button
