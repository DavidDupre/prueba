    ...
    <q-dialog v-model="open">
      <q-card class="tw-p-5 tw-w-[400px] tw-h-11/12">
        ...
        <div class="tw-rounded-lg  tw-mt-3">
          ...
          <FileLoader :max-file-size="5 * 1024 * 1024" max-file-size-label="5MB"
                      v-model:model-value="formData.documentos" accept-file="pdf, png, jpg, jpeg, webp, bmp, txt, doc, docx, xls, xlsx, mp3, mp4, avi, csv, zip, rar, ppt, pptx, eml, msg"> </FileLoader>
