<template>
  <q-input :type="type" :rules="computedRules" outlined dense
  :model-value="modelValue" @update:model-value="updateValue" class :rounded="rounded" />
</template>
...
import {
  ...
  maxLengthField,
  minLengthField,
} from "src/shared/utils/Input/validationInput";
