        ...
        <q-card class="tw-p-10">
          ...
          <span class="text-weight-bold text-h6" style="color: #2c3948">Correos electrónico *</span>
                    ...
                    <q-item class="tw-border-b">
                        ...
                        <q-item-section side>
                            <q-btn flat size="sm" padding="xs" rounded color="orange-7" icon="add" @click="addNewItem" />
                        </q-item-section>
                    </q-item>
                <div v-for="(item, index) in selectedItems" :key="index">
                    <q-item class="tw-border-b">
                        ...
                        <q-item-section>
                            <q-input v-model="selectedItems[index]" borderless dense />
                        </q-item-section>
...
const selectedItems = ref<string[]>([])
  function addNewItem() {
    ...
    selectedItems.value.push(correo.value);
    correo.value = '';
