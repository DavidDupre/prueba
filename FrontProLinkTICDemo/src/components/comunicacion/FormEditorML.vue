<template>
  <div>
    <q-card class="tw-rounded-xl tw-py-6 tw-px-8 tw-pb-6 tw-mt-6" flat>
      <section>
        ...
        <div class="tw-grid tw-grid-cols-4 tw-gap-4">
          <div class="tw-col-span-4">
            ...
            <q-input outlined dense v-model="formGeneralData.asuntoCorreo" readonly filled />
          </div>
        </div>
      </section>
    </q-card>
...
formGeneralData.value.contenidoCorreo = content
